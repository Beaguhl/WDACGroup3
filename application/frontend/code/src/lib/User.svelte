<script>
	...
	async function loadUser() {
		try {
			const response = await fetch("http://13.53.123.120:8080/users/" + id, {
				method: "GET",
				headers: {
					"Content-Type": "application/json",
					Authorization: "bearer " + $user.accessToken,
	...
	async function followUser() {
		try {
			const response = await fetch("http://13.53.123.120:8080/followings", {
				method: "POST",
				headers: {
					"Content-Type": "application/json",
					Authorization: "bearer " + $user.accessToken,
	...
	async function purchaseProduct(wishListProductID) {
		try {
			const response = await fetch(
				"http://13.53.123.120:8080/wishlist-product/" + wishListProductID + "/purchase",
				{
					method: "PATCH",
					headers: {
						"Content-Type": "application/json",
	...
	async function undoPurchaseProduct(wishListProductID) {
		try {
			const response = await fetch(
				"http://13.53.123.120:8080/wishlist-product/" + wishListProductID + "/undo-purchase",
				{
					method: "PATCH",
					headers: {
						"Content-Type": "application/json",
